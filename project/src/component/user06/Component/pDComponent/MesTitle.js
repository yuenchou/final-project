...
const MesTitle = ({cmmtList, vgtid, seller}) => {
    ...
    return (
        <div  class="card mt-5 col-9">
            ...
            <div id="mesTitle" className="card-body row ">
                ...
                {cmmtList.length === 0 && <div className="mb-5"></div>}
                {cmmtList.map(val => (
                    <div className="card-text col-10 ms-5 p-3 mt-1 mb-3 border-bottom border-info">
